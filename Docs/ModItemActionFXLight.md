...
ActionFXLight
==================
This mod item places light sources when an FX action is triggered. Inherits [ActionFX](ActionFX.md).

Properties
------------------
GameTimeAnimated
: Whether the light should be game time animated.
...
Spot
: Target spot, relative to which the light will be placed.

Attach
: Whether to attach the light to the target object. Set to true if the light should move with the source.
