# Documentation for *cameraMax*

## cameraMax.Activate

Activates the Max the camera.<br>
...
Returns camera position and 'look at' point<br>
...
Check if the Max camera is active.<br>

bool **cameraMax.IsActive**()

## cameraMax.SetAnimObj

Attach camera to the object spot "Camera", looking to another object spot "Target". Camera horizontal FOV is controlled by the spot scale, interpret as radians multiplied by 1000.<br>
...
Set camera position,'look at' and roll<br>
