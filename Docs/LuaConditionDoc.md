...
## CheckTerraformingParam

Checks if the specified Terraforming parameter has reached certain percentage value.
Terraforming Param
: Select the parameter to check.

Amount
: Set the percentage value to check against.
...
Checks the quantity of the specified resource type of the associated Rival colony against a specific value.
Condition
: Select the relation to the specified value.
...
Checks the number of Rival colonies operating on Mars against the specified amount.
Condition
: Select the relation to the specified value.
...
Checks if the player has at least one Rocket landed on Mars.
DisabledDescriptionOnly
: Use disabled description in negotiation replies text.
...
Checks whether the last completed milestone is the one specified.
Negate Condition
: if true, checks for the opposite condition

Milestone
: Select Milestone to check for.
...
Check whether one of the rivals has already built the specified wonder.
Negate Condition
: if true, checks for the opposite condition

Wonder
: Select a wonder to check against.
...
Pick a random rival colony which satisfies the condition specified.
Conditions
: List all the conditions the rival colony has to fulfill in order to be chosen.
...
## RivalAcceptDistressCall

Checks if the associated rival colony will accept the player's distress call.
## RivalHasOpenedTradeRoute

Checks if the associated rival colony has opened a trade route.
Negate Condition
: if true, checks for the opposite condition

## RivalHasTech

Checks if the associated rival colony has researched a certain technology.
Negate Condition
: if true, checks for the opposite condition

Tech
: Select a technology to check against.

## RivalHasTechYouDont

Checks if the associated rival colony has researched a technology which the player hasn't.
Negate Condition
: if true, checks for the opposite condition

## RivalHasWonder

Checks if the associated rival colony has built a specific wonder.
Negate Condition
: if true, checks for the opposite condition
...
Checks if the associated rival colony has a specific sponsor.
SponsorName
: Select a sponsor to check against.
...
Checks if the player has more than a certain amount of Standing with the associated rival colony.
Standing
: Set the standing to check against.
...
Checks if the player has one of two levels of Standing with the associated rival colony.
Standing1
: Select the first one of the possible standings for the Rival Colony.

Standing2
: Select the second one of the possible standings for the Rival Colony.
...
Checks the player's maximal standing with any rival against a specific amount.
Amount
: Set the amount to chek against.
...
Checks the player's minimal standing with any rival against a specific amount.
Amount
: Set the amount to chek against.
