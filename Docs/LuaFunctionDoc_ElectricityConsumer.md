# Documentation for *ElectricityConsumer*

## Overview

Building derived [building template](ModItemBuildingTemplate.md) class. Handles power consumption for a building. All buildings in the game that consume power inherit or are this class.<br>
## Parent classes
...
**disable_electricity_consumption**
: So consumption can be turned off with modifiers
### Template Properties
...
**penalty_heat**
: Heat at which the cold penalty is applied

**penalty_pct**
: Cold penalty percents

**freeze_time**
: Freeze time if under the freeze heat

**defrost_time**
: Defrost time if above the freeze heat

**freeze_heat**
: Below that heat the building begins to freeze
#### Construction
