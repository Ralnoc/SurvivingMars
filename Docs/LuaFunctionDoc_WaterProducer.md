# Documentation for *WaterProducer*

## Overview

Building derived [building template](ModItemBuildingTemplate.md) class. Handles water production for a building. All buildings that produce water for the water grid are either of this class or a derived class.<br>
## Parent classes
...
**water_production**
: This is the amount produced per hour.
### Template Properties
