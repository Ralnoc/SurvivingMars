...
Returns the first found object (or nil) in a grid that is located in the hex defined by q, r, and that match all optianal filters.<br>
<br>
...
Returns a Lua int based array that contains all objects in a grid that are located in the hex defined by pos or q, r, and that match all optianal filters.<br>
<br>
...
Returns a Lua int based array that contains all objects in a grid that are located in the hex defined by pos or q, r, and it's neighbouring hexes within range, and that match all optianal filters.<br>
<br>
...
Applies an object to a grid, taking care of object co-habitation. The hexes in which the object is added are defined by the object's position, rotation and the shape provided.<br>
<br>
...
Removes an object from a grid, taking care of object co-habitation. The hexes from which the object is removed are defined by it's position, rotation and the provided shape. It is paramount that the hexes cleared are the same hexes where the building was first applied with HexGridShapeAddObject.<br>
<br>
