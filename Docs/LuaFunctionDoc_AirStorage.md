# Documentation for *AirStorage*

## Overview

Building derived [building template](ModItemBuildingTemplate.md) class. Handles air storage.<br>
## Parent classes
...
**max_air_charge**
: This is the amount of Oxygen the battery can charge per hour.

**max_air_discharge**
: This is the amount of Oxygen the battery can discharge per hour.

**air_conversion_efficiency**
