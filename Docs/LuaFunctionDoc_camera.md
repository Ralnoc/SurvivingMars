...
Deactivate the current view camera.<br>
...
Returns camera direction vector with length 1024.<br>
...
Returns horizontal FOV in angular minutes.<br>
...
Returns vertical FOV in angular minutes.<br>
...
Returns camera pitch in angular minutes.<br>
...
Returns the terrain area observed by the camera (a trapeze).<br>
...
Return camera view render window box<br>
...
Returns camera yaw in angular minutes.<br>
...
Returns if the camera is locked.<br>
...
Check if a game position is within the rendered view<br>
...
Specify auto adjustible FOV depend on the resolution aspect.<br>
The FOV is linearly interpolated between minimal and maximal FOV depend on the current aspect.<br>
For aspects lower than minimal aspect, horizontal FOV is fixed on the specified minimal FOV.<br>
For aspects greater than maximal aspect, vertical FOV is fixed on the specified maximal FOV.<br>
...
Set horizontal FOV. (the vertical FOV will be auto adjusted depend on the aspect ratio)<br>
...
Set vertical FOV. (the horizontal FOV will be auto adjusted depend on the aspect ratio)<br>
...
Set camera view render window box<br>
